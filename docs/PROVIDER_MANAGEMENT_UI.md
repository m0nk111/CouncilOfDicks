...
- **[AI_PROVIDERS.md](AI_PROVIDERS.md)**: Technical details of the provider architecture.
- **[UI_UX_SPECS.md](UI_UX_SPECS.md)**: General UI/UX guidelines for the application.
