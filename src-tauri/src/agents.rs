...
impl AgentPool {
    ...
    pub async fn add_agent(&self, agent: Agent) -> Result<String, String> {
        ...
        if agents.values().any(|a| a.name == agent.name && a.id != agent.id) {
...
impl Tool {
    ...
    pub fn vote() -> Self {
        Self {
            name: "vote".to_string(),
            description: "Cast a vote on the current question. Use this when you've reached a conclusion.".to_string(),
            parameters: serde_json::json!({
                "type": "object",
                "properties": {
                    "vote": {
    ...
    pub fn search_knowledge() -> Self {
        Self {
            ...
            description: "Search the council's knowledge bank for relevant past decisions and context.".to_string(),
            parameters: serde_json::json!({
                "type": "object",
                "properties": {
                    "query": {
